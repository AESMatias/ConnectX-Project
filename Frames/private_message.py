...
class PrivateMessageFrameSecond(QWidget):
    ...
    def __init__(self, parent=None, username=None, to_username=None):
        super().__init__()
        ...
        # We set the geometry of the window
    ...
    def send_message_func(self, from_username=None, message_text=None, to_username=None):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print('Mensaje del usuario', self.username)
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(
                    f"Error al enviar el mensaje. Código de estado: {response.status_code}")
                print(response.text)
                print(' desde ', from_username, ' para ', to_username)
        except requests.RequestException as e:
            print(f"Error de conexión: {e}")
